        ...
        if (save) {
            ...
            if (!this._props.multiple) {
                ...
                if (!this._props.singleVal.depth || !this._props.singleVal.val) {
                    await this.toastService.presentToast("page-new-obs.measures.temperature.error-msg-val", Duration.short);
                    return;
                }
                ...
                this.obsService.newObservation.measures.temperature.val = [...this._props.multipleVal];
