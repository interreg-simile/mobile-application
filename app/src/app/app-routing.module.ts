  ...
  },
  {
    ...
    children: [
      {path: '', redirectTo: '/observations/new', pathMatch: 'full'},
      {
        path: 'new',
        loadChildren:
          './observations/new-observation/new-observation.module#NewObservationPageModule',
      },
      {
        path: ':id',
  ...
  },
  {
    ...
    children: [
      {path: '', loadChildren: './news/news.module#NewsPageModule'},
      {
        path: 'alerts/:id',
        loadChildren:
          './news/alerts/single-alert/single-alert.module#SingleAlertPageModule',
      },
      {
        path: 'events/:id',
        loadChildren:
          './news/events/single-event/single-event.module#SingleEventPageModule',
      },
    ],
  },
  {
